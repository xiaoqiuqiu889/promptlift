...
- **场景与档位联动**：四种表达场景分别使用自己的提示策略和档位定义；“场景”是唯一入口，不再重复设置“工作模式”。
- **系统提示词透明可调**：在“优化档位”页点击“查看当前档位系统提示词”，可查看 4 种场景 × 4 个档位的默认规则，并为当前场景/档位保存本机自定义补充规则。
...
1. 在仓库的 Releases/文件列表中下载 [Prompt-Lift-20260804-r6-win32-x64.zip](deliverables/Prompt-Lift-20260804-r6-win32-x64.zip)。
...
仓库里也保留了可直接查看和下载的 [Prompt Lift.exe](deliverables/Prompt-Lift-20260804-r6/Prompt%20Lift-win32-x64/Prompt%20Lift.exe)。如果浏览器提示大文件由 Git LFS 管理，下载 ZIP 会更稳妥。
...
4. 在底部“场景”页选择 AI 提示词、向上沟通、用户沟通或 PPT 文案，再到“处理”页选择优化档位。
...
当前版本的自动化回归为 **204/204 通过**，Windows 界面验收覆盖 86 个状态，包含默认双击 Alt、自定义快捷键录制与恢复、取消、审阅、恢复、场景切换、档位差异、系统提示词查看/编辑、三种小精灵和拖拽命中测试。

打包结果默认写入 `deliverables/`。本仓库当前发布包为：

```text
deliverables/Prompt-Lift-20260804-r6-win32-x64.zip
deliverables/Prompt-Lift-20260804-r6/Prompt Lift-win32-x64/Prompt Lift.exe
```
